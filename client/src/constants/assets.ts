...
import type { AiTool, DummyCreation, DummyPublishedCreation, DummyTestimonial } from "../types";
...
export const dummyTestimonialData: DummyTestimonial[] = [
    {
...
export const dummyCreationData: DummyCreation[] = [
    {
        "id": 9,
...
export const dummyPublishedCreationData: DummyPublishedCreation[] = [
    {
        "id": 1,
        "user_id": "user_2yMX02PRbyMtQK6PebpjnxvRNIA",
